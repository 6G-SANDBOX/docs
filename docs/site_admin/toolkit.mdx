...
import { SANDBOX_URL, MARKETPLACE_SERVICE_TOOLKIT, ONE_REPO_RELEASE, ONE_REPO_VERSION, SITES_ACCESS_REQUEST_ISSUE, SANDBOX_REPO_ORG, SANDBOX_REPO_TEAMS_SITES, TOOLKIT_INSTALLER_INSTALL_SCRIPT } from "@site/src/constants/v0.5.1";

Toolkit installer is a Python script developed for the <Link to={SANDBOX_URL}>6G-SANDBOX</Link> project, designed to facilitate the creation of new 6G-SANDBOX [sites](../6g-sandbox-sites/home.mdx).
