---
sidebar_position: 4
title: "Trial Network Descriptor"
sidebar_label: "TN Descriptor"
draft: false
---

import Link from "@docusaurus/Link";
import { LIBRARY_REPO_URL, TNLCM_BACKEND_SAMPLE_DESCRIPTORS_README, TNLCM_BACKEND_ELCM_TRIAL_NETWORK, TNLCM_BACKEND_LOADCORE_TRIAL_NETWORK } from "@site/src/config/constants";

# Trial Network Descriptor

A Trial Network Descriptor is a YAML file that defines the structure and configuration of a trial network, describing all the components involved, their types, names, dependencies,
and input parameters. It acts as a blueprint that the TNLCM uses to orchestrate the deployment of the trial network, ensuring that all required resources are created and connected
