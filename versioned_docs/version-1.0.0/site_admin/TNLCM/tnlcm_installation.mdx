...
import { ONE_REPO_RELEASE, ONE_REPO_VERSION, MINIO_REPO_RELEASE, MINIO_REPO_VERSION, JENKINS_REPO_RELEASE, JENKINS_REPO_VERSION, TNLCM_BACKEND_INSTALL_SCRIPT, TNLCM_FRONTEND_INSTALL_SCRIPT } from "@site/src/constants/v1.0.0";
