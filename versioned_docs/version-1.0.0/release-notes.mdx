...
import { MARKETPLACE_URL, TOOLKIT_INSTALLER_REPO_URL, TNLCM_BACKEND_REPO_URL, LIBRARY_REPO_URL, SITES_DUMMY_SITE, SITES_REPO_URL } from "@site/src/constants/v1.0.0";

## :calendar: **2025-09-05**

### :fire: **What's New?**

#### :brain: **TNLCM backend v1.0.0**

:link: **Repository:** <Link to={TNLCM_BACKEND_REPO_URL}>6G-SANDBOX/TNLCM</Link>

:page_facing_up: **Changelog:** [TNLCM Release Notes](https://github.com/6G-SANDBOX/TNLCM/releases/tag/v1.0.0)

Upgrade TNLCM following the instructions [here](./site_admin/TNLCM/tnlcm_upgrade.mdx).

#### :wrench: **Toolkit Installer v1.0.0**

:link: **Repository:** <Link to={TOOLKIT_INSTALLER_REPO_URL}>6G-SANDBOX/toolkit-installer</Link>

:page_facing_up: **Changelog:** [Toolkit Installer Release Notes](https://github.com/6G-SANDBOX/toolkit-installer/releases/tag/v1.0.0)

To install the new version of the toolkit installer, follow the instructions [here](./site_admin/toolkit.mdx).

#### :books: **6G-Library v1.0.0**

:link: **Repository:** <Link to={LIBRARY_REPO_URL}>6G-SANDBOX/6G-Library</Link>

:page_facing_up: **Changelog:** [6G-Library Release Notes](https://github.com/6G-SANDBOX/6G-Library/releases/tag/v1.0.0)
